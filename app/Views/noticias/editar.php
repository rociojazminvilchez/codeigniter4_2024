...
<h3 class="my-3">Editar noticia</h3>
...
<form action="<?= base_url('noticias/' . $not['id']); ?>" class="row g-3" method="post" enctype="multipart/form-data" autocomplete="off">
    <p style="text-align:right;">
      ...
      <input type="text" name="titulo" value="<?= $not['titulo']; ?>" required ><br><br>

      <span class="error">*</span> Descripci&oacute;n:<br>
        <input type="text" name="descripcion" value="<?= $not['descripcion']; ?>" required><br><br>
      ...
      <span class="error">*</span>   
        ...
        <!-- Correo oculto-->
          <input type="hidden" name="Email" value="<?= $not['correo']; ?>">
