...
<body>
<br><br><br>
<form action="<?= base_url('noticias/'. $not['id'].'/update2'); ?>" method="post" enctype="multipart/form-data" style="margin-bottom:75px;">
<input type="hidden" name="_method" value="put">
<input type="hidden" name="estado_modificado" value="deshacer">
